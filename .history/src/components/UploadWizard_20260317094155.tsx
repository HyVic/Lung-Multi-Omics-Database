              ...
              <Form layout="vertical">
                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 32 }}>
                  ...
                  <div>
                    ...
                    style={{ marginBottom: 20 }} clealrable
                  >
                    <Input
                      value={data.name}
                    ...
                    {["SampleID", "Species", "Disease", "Age", "Sex", "Tissue", "RIN", "Group"].map((col) => (
                      <tr key={col} style={{ borderBottom: "1px solid #F1F5F9" }}>
                        ...
                        <td style={{ padding: "8px 0" }}>
                          <Select size="small" style={{ minWidth: 120 }} defaultValue={col.toLowerCase().replace("id", "_id")}>
                            <Select.Option value={col.toLowerCase().replace("id", "_id")}>{col.toLowerCase().replace("id", "_id")}</Select.Option>
                          </Select>
                        </td>
                      </tr>
                    ))}
