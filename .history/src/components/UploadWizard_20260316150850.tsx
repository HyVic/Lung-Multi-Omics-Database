...
const OMICS_TYPES = [
  {
    ...
    color: "#3B82F6",
    obi: "OBI:0001271",
    desc: "Bulk transcriptome sequencing data",
  },
  {
    value: "scRNA-seq",
    label: "scRNA-seq",
    ...
    color: "#8B5CF6",
    obi: "OBI:0002631",
    desc: "Single-cell transcriptome sequencing",
  },
  {
    value: "ATAC-seq",
    label: "ATAC-seq",
    ...
    color: "#10B981",
    obi: "OBI:0002039",
    desc: "Assay for Transposase-Accessible Chromatin",
  },
  {
    value: "proteomics",
    label: "Proteomics",
  ...
  },
  {
    ...
    color: "#F97316",
    obi: "OBI:0000366",
    desc: "Lipidomics profiling data",
  },
  {
    value: "methylation",
    ...
    color: "#06B6D4",
    obi: "OBI:0001003",
    desc: "Bisulfite sequencing methylation",
  },
  {
    value: "chip-seq",
    label: "ChIP-seq",
    ...
    color: "#22C55E",
    obi: "OBI:0001864",
    desc: "Chromatin immunoprecipitation sequencing",
  },
  {
    value: "metabolomics",
    label: "Metabolomics",
    ...
    color: "#EC4899",
    obi: "OBI:0000070",
    desc: "Metabolomics profiling data",
  },
];
...
const TISSUES = [
  ...
  {
    value: "alveolar lumen",
    label: "Alveolar Lumen",
    uberon: "UBERON:0002314",
  },
  {
    value: "respiratory epithelium",
    label: "Respiratory Epithelium",
    uberon: "0001004",
  },
  {
    value: "bronchial epithelium",
  ...
  {
    value: "bronchoalveolar lavage fluid",
...
const CELLS = [
  ...
  {
    value: "pulmonary endothelial cell",
    label: "Pulmonary Endothelial Cell",
    cl: "CL:0002187",
  },
  {
  ...
  {
    value: "multipotent stem cell",
    label: "Multipotent Stem Cell",
    cl: "CL:0000048",
  },
  { value: "cell population", label: "Cell Population (Bulk)", cl: "" },
  {
    value: "cell type collection",
    label: "Cell Type Collection (scRNA)",
    cl: "",
  },
];
...
const DISEASES = [
  ...
  },
  {
    value: "MONDO:0005167",
    mondo: "MONDO:0005167",
    label: "IPF (Idiopathic Pulmonary Fibrosis)",
  },
        ...
        <div style={{ padding: 24, overflowY: "auto", flex: 1 }}>
                ...
                {OMICS_TYPES.map((o) => (
                  <div
                    ...
                    style={{
                      ...
                      cursor: "pointer",
                      background:
                        data.omicsType === o.value ? o.color + "08" : "#fff",
                  ...
                  >
                    ...
                    <div style={{ fontSize: 11, color: o.color, marginTop: 4 }}>
                      {o.obi}
                    </div>
                    <div
                ...
                <div>
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateData({ subDisease: e.target.value })
                      }
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateData({ treatment: e.target.value })
                      }
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <input
                      value={
                        data.comparison || "old (age≥50) vs young (age≤40)"
                      }
                      onChange={(e) =>
                        updateData({ comparison: e.target.value })
                      }
                ...
                <div>
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <div
                      style={{ fontSize: 11, color: "#6B7280", marginTop: 4 }}
                    >
                      Select the most specific anatomical level
                    </div>
                  </div>
                  <div style={{ marginBottom: 20 }}>
                    <label
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <div
                      style={{ fontSize: 11, color: "#6B7280", marginTop: 4 }}
                    >
                      Auto-filled from Step 0, cannot be modified
                    </div>
                  </div>
                  <div style={{ marginBottom: 20 }}>
                    <label
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateData({ libraryPlatform: e.target.value })
                      }
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateData({ sequencingPlatform: e.target.value })
                      }
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <select
                      ...
                      onChange={(e) =>
                        updateData({ sourceDatabase: e.target.value })
                      }
                      style={{
                        width: "100%",
                        padding: "10px 12px",
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    <input
                      ...
                      onChange={(e) =>
                        updateData({ accession: e.target.value })
                      }
                      placeholder={
                        data.sourceDatabase === "In-house"
                          ? "e.g., LM-001"
                          : "e.g., GSE198980"
                      }
                      style={{
                    ...
                    <div style={{ display: "flex", gap: 24 }}>
                      <label
                        style={{
                          ...
                          cursor: "pointer",
                          padding: "10px 16px",
                          border: `1px solid ${data.accessLevel === "Open" ? "#3B82F6" : "#D1D5DB"}`,
                          borderRadius: 8,
                          background:
                            data.accessLevel === "Open" ? "#EFF6FF" : "#fff",
                        }}
                      >
                        <input
                          type="radio"
                          name="accessLevel"
                          checked={data.accessLevel === "Open"}
                          onChange={() => updateData({ accessLevel: "Open" })}
                          style={{ display: "none" }}
                        />
                        <span
                          style={{
                            ...
                            height: 16,
                            borderRadius: "50%",
                            border: `2px solid ${data.accessLevel === "Open" ? "#3B82F6" : "#D1D5DB"}`,
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                          }}
                      ...
                      <label
                        style={{
                          ...
                          cursor: "pointer",
                          padding: "10px 16px",
                          border: `1px solid ${data.accessLevel === "Controlled" ? "#3B82F6" : "#D1D5DB"}`,
                          borderRadius: 8,
                          background:
                            data.accessLevel === "Controlled"
                              ? "#EFF6FF"
                              : "#fff",
                        }}
                      >
                        <input
                          type="radio"
                          name="accessLevel"
                          checked={data.accessLevel === "Controlled"}
                          onChange={() =>
                            updateData({ accessLevel: "Controlled" })
                          }
                          style={{ display: "none" }}
                        />
                        <span
                          style={{
                            ...
                            height: 16,
                            borderRadius: "50%",
                            border: `2px solid ${data.accessLevel === "Controlled" ? "#3B82F6" : "#D1D5DB"}`,
                            display: "flex",
                            alignItems: "center",
                            justifyContent: "center",
                          }}
          ...
          {step === 2 && (
            <div>
              ...
              {(data.omicsType === "bulk RNA-seq" ||
                data.omicsType === "Total RNA-seq" ||
                data.omicsType === "polyA RNA-seq") && (
                <div
                  style={{
                ...
                >
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    >
                      Format: .xlsx / .csv | Must contain: sample_id, tissue,
                      disease, age, sex, group
                    </div>
                    <FileUploadZone
                      file={data.metaFile}
                      onFileSelect={(file) =>
                        updateData({
                          metaFile: { name: file.name, data: file },
                        })
                      }
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    >
                      ...
                      >
                        Gene Expression Matrix (FPKM / TPM / raw count)
                      </span>
                      <span style={{ fontSize: 11, color: "#6B7280" }}>
                        (recommended)
                      </span>
                    ...
                    >
                      Format: .xlsx / .tsv / .csv | Rows = genes, Columns =
                      samples
                    </div>
                    <FileUploadZone
                      ...
                      onFileSelect={(file) =>
                        updateData({
                          expressionFile: { name: file.name, data: file },
                        })
                      }
                    ...
                    {data.expressionFile && (
                      <div style={{ marginTop: 12 }}>
                        ...
                        {["FPKM", "TPM", "CPM", "Raw count"].map((unit) => (
                          ...
                          >
                            <input
                              ...
                              onChange={() =>
                                updateData({ expressionUnit: unit })
                              }
                            />
                            {unit}
                          </label>
                        ...
                        <input
                          ...
                          value={
                            data.expressionUnit &&
                            !["FPKM", "TPM", "CPM", "Raw count"].includes(
                              data.expressionUnit,
                            )
                              ? data.expressionUnit
                              : ""
                          ...
                          onChange={(e) =>
                            updateData({ expressionUnit: e.target.value })
                          }
                          style={{
                            padding: "4px 8px",
                            border: "1px solid #D1D5DB",
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    >
                      ...
                      >
                        Differentially Expressed Genes (DEG, can upload
                        multiple)
                      </span>
                      <span style={{ fontSize: 11, color: "#6B7280" }}>
                        (recommended)
                    ...
                    >
                      Format: .xlsx / .tsv / .csv | Must contain: gene, logFC,
                      p-value, FDR
                    </div>
                    <FileUploadZone
                      multiple
                      onFilesSelect={(files) => {
                        ...
                        updateData({
                          degFiles: [...data.degFiles, ...newDegFiles],
                        });
                      }}
                      acceptedTypes=".xlsx,.tsv,.csv"
                    />
                    {data.degFiles.length > 0 && (
                      <div style={{ marginTop: 12 }}>
                        ...
                        >
                          Each DEG file comparison definition:
                        </div>
                        {data.degFiles.map((deg, i) => (
                          ...
                          >
                            ...
                            >
                              ...
                              <button
                                onClick={() => {
                                  const newDegFiles = data.degFiles.filter(
                                    (_, idx) => idx !== i,
                                  );
              ...
              {data.omicsType === "scRNA-seq" && (
                ...
                >
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    >
                      Format: .xlsx / .csv | Must contain: sample_id, cell_type,
                      tissue, disease, age, sex
                    </div>
                    <FileUploadZone
                      file={data.metaFile}
                      onFileSelect={(file) =>
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    >
                      ...
                      >
                        Single-cell Expression Matrix (Raw counts)
                      </span>
                      <span style={{ fontSize: 11, color: "#6B7280" }}>
                        (required)
                      </span>
                    ...
                    >
                      Format: .mtx / .tsv / .csv | Rows = genes, Columns =
                      cells; or 10X format (barcodes.tsv, features.tsv,
                      matrix.mtx)
                    </div>
                    <FileUploadZone
                      file={data.expressionFile}
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    >
                      Format: .xlsx / .csv | Must contain: cell_id, cluster_id,
                      cell_type
                    </div>
                    <FileUploadZone
                      multiple
                      onFilesSelect={(files) =>
                        console.log("Cluster files:", files)
                      }
                      acceptedTypes=".xlsx,.csv"
                    />
                  </div>
                  ...
                  <div style={{ marginBottom: 20 }}>
                    ...
                    >
                      Format: .xlsx / .tsv / .csv | Must contain: gene, cluster,
                      p_val, avg_log2FC
                    </div>
                    <FileUploadZone
                      multiple
                      onFilesSelect={(files) =>
                        console.log("Marker files:", files)
                      }
                      acceptedTypes=".xlsx,.tsv,.csv"
                    />
                  </div>
          ...
          {step === 3 && (
            <div>
              ...
              >
                Column Mapping & Ontology Annotation
              </div>
              <div
                style={{
                  background: "#F8FAFC",
              ...
              >
                ...
                >
                  Sample Metadata Column Mapping
                </div>
                <table
                  style={{
                    width: "100%",
                  ...
                  <tbody>
                    {[
                      ...
                      >
                        ...
                        <td style={{ padding: "8px 0", color: "#10B981" }}>
                          ✓ Auto
                        </td>
                        <td style={{ padding: "8px 0" }}>
                          ...
                          >
                            <option>
                              {col.toLowerCase().replace("id", "_id")}
                            </option>
                          </select>
                        </td>
                      </tr>
            ...
            <div>
              ...
              >
                ...
                <div style={{ fontSize: 13, lineHeight: 1.8 }}>
                  ...
                  <div>
                    <strong>Tissue:</strong> {data.tissue}
                  </div>
                  <div>
                    <strong>Disease:</strong> {data.disease}
                  </div>
                  <div>
                    <strong>Omics:</strong> {data.omicsType}
                  </div>
                  <div>
                    <strong>Source:</strong> {data.sourceDatabase} /{" "}
                    {data.accession}
                  </div>
                </div>
              </div>
              ...
              >
                ...
                <div style={{ fontSize: 13, color: "#6B7280" }}>
                  Sample column mapping completed
                </div>
              </div>
              <div
                style={{
          ...
          {step < 4 ? (
            <button
              ...
              style={{
                ...
                border: "none",
                borderRadius: 8,
                background: canProceed() ? "#3B82F6" : "#94A3AF",
                color: "#fff",
                fontSize: 13,
                fontWeight: 600,
